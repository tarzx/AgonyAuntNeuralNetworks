...
public class Util {
	public static final String METHOD_URL = "http://pl44.host.cs.st-andrews.ac.uk/AndroidApp/v2/select_sequence_to_CSV.php";
	public static final String DATA_URL = "http://pl44.host.cs.st-andrews.ac.uk/AndroidApp/v2/selectSequence.csv";
	
	// CSV File
	static String dataCSVFileNameLoad = "selectSequence.csv";
	static String dataCSVFileName = "selectSequenceRefine.csv";
	...
	static final int NUM_OUTPUT_BITS = NUM_SEQ;
	...
	static File neuralNetfile = new File("neuralNetSelectSequence.eg");
