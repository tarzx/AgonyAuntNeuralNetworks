...
public class Util {
	...
	static String dataCSVFileName = "frequencyInterventionRefine.csv";
	...
	static final int NUM_OUTPUT_BITS = NUM_FREQ;
	...
	static File neuralNetfile = new File("neuralNetfrequencyIntervention.eg");
