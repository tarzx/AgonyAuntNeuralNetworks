...
public class Util {
	public static final String METHOD_URL = "http://pl44.host.cs.st-andrews.ac.uk/AndroidApp/select_behaviour_to_CSV.php";
	public static final String DATA_URL = "http://pl44.host.cs.st-andrews.ac.uk/AndroidApp/selectBehaviour.csv";
