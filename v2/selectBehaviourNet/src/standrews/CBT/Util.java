...
public class Util {
	...
	public static final String METHOD_URL = "http://pl44.host.cs.st-andrews.ac.uk/AndroidApp/v2/select_behaviour_to_CSV.php";
	public static final String DATA_URL = "http://pl44.host.cs.st-andrews.ac.uk/AndroidApp/v2/selectBehaviour.csv";
	
	// CSV File in process
	static String dataCSVFileNameLoad = "selectBehaviour.csv";
	static String dataCSVFileName = "selectBehaviourRefine.csv";
	...
	// neural network file
	static File neuralNetfile = new File("neuralNetSelectBehaviour.eg");
